...
##############frame
        ...
        register_lbl=Label(frame,text="Register Here",font=("times of new roman",20,"bold"),fg="green",bg="white")
        ...
        security_Q = Label(frame, text="Select Security Ques:", font=("times of new roman", 15, "bold"), fg="black", bg="white")
        security_Q.place(x=50, y=240)

        self.combo_security_Q=ttk.Combobox(frame,textvariable=self.var_securityQ,font=("times of new roman", 15, "bold"),state="readonly")
        self.combo_security_Q["values"]=("Select","Your Birth date","your name")
        self.combo_security_Q.place(x=50,y=270,width=250)
        self.combo_security_Q.current(0)

        security_A=Label(frame,text=" security answers",font=("times of new roman", 15, "bold"),bg="white",fg="black")
        security_A.place(x=370,y=240)


        self.txt_security = ttk.Entry(frame,textvariable=self.var_SecurityA, font=("times of new roman", 15, "bold"))
        ...
        confirm_pswd = Label(frame, text="Confirm Password", font=("times of new roman", 15, "bold"), bg="white", fg="black")
        confirm_pswd.place(x=370, y=310)

        self.txt_confirm_pswd = ttk.Entry(frame,textvariable=self.var_confpass, font=("times of new roman", 15, "bold"))
        self.txt_confirm_pswd.place(x=370, y=340, width=250)

        #############################check button
        self.var_check=IntVar()
        checkbtn=Checkbutton(frame,variable=self.var_check,text="I Agree the Terms and Conditions",font=("times of new roman", 15,"bold"),onvalue=1,offvalue=0)
        ...
        b1=Button(frame,image=self.photoimage,command=self.register_data,borderwidth=0,cursor="hand2",font=("times of new roman", 15,"bold"))
